  ...
  )
{
  ...
  if (SiCfgData == NULL) {
    ...
    // TSN feature support
#if PLATFORM_RPLS || PLATFORM_RPLP || PLATFORM_RPLPS || PLATFORM_ADLP || PLATFORM_ADLPS || PLATFORM_ADLS || PLATFORM_BTLS
  ...
  DEBUG((DEBUG_INFO, "RPL1:Enabling TXT in FSP-S UPD's\n"));
